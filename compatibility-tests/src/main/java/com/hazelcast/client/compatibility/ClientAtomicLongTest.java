...
package com.hazelcast.client.compatibility;
...
public class ClientAtomicLongTest extends HazelcastTestSupport {
    ...
    public void setup() {
        ...
        l = client.getAtomicLong(HazelcastTestSupport.randomString());
    }
    ...
    public void apply() {
        ...
        Assert.assertEquals(new Long(1), ref.apply(new AddOneFunction()));
    ...
    public void alterAndGet() {
        ...
        ref.set(10);
        Assert.assertEquals(11, ref.alterAndGet(new AddOneFunction()));
        Assert.assertEquals(11, ref.get());
    }
    ...
    public void getAndAlter() {
        ...
        ref.set(10);
        Assert.assertEquals(10, ref.getAndAlter(new AddOneFunction()));
        Assert.assertEquals(11, ref.get());
    }
